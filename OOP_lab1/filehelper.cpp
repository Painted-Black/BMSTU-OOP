...
//    Errors err = readSize(&count, file);

//    if (err == OK)
//    {
//        err = allocPoints(fr.points, count);
//        if (err)
//            return err;
//        err = readPoints(fr.points.array_points, file, count);
//        if (err != OK)
//        {
//            clearPoints(fr.points);
//        }
...
//            err = allocEdges(fr.edges, count);
//            if (err)
//            {
//                clearEdges(fr.edges);
//                return err;
//            }
//            err = readEdges(fr.edges.array_edges, file, count);
//        }
//    }
//    return err;
}
